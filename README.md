...
blockPoll is a pseudo-anonymous, online, blockchain-based voting tool, used to facilitate orginisational-based proxy voting and polling mechanisims for a wide array of uses. 
